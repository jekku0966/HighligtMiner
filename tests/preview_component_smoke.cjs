...
const player = {readyState: 1, duration: 30.04, currentTime: 5.25, error: null,
  pauseCount: 0, loadCount: 0, pause() {this.pauseCount++;}, load() {this.loadCount++;},
  addEventListener() {}};
...
console.log('Component handshake, marks, acknowledgement, playhead preservation, and candidate reset passed.');
